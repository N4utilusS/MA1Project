...
\begin{description}
	...
	\item[Exportation of the database] The database could be exported to specified file type for consultation on another device. This file could be printed to make a human readable "book" of the content of a wine cellar.
...
\vfill
\center \includegraphics{Images/icon.png}
